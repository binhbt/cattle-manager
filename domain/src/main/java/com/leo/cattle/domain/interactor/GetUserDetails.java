 ...
 * retrieving data related to an specific {@link com.leo.cattle.domain.User}.
 */
public class GetUserDetails extends UseCase {
  ...
  public GetUserDetails(int userId, UserRepository userRepository,
      ThreadExecutor threadExecutor, com.leo.cattle.domain.executor.PostExecutionThread postExecutionThread) {
