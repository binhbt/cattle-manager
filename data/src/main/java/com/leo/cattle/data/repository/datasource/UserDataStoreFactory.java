...
public class UserDataStoreFactory {
  ...
  public UserDataStore createCloudDataStore() {
    ...
    ChatSessionEntityJsonMapper sessionEntityJsonMapper = new ChatSessionEntityJsonMapper();
    //RestApi restApi = new RestApiImpl(this.context, userEntityJsonMapper, sessionEntityJsonMapper);
    ApiService restApi = new ApiService();
    return new CloudUserDataStore(restApi, this.userCache);
  }

  public UserDataStore createForSession() {
    UserDataStore userDataStore;
    userDataStore = new DiskUserDataStore(this.userCache);
